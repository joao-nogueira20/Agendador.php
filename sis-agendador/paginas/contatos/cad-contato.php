...
<div>
    <form class="needs-validation" action="index.php?menuop=inserir-contato" method="post" novalidate>
        <div class="mb-3"><!-- classe:Margin Bottom 3px-->
            ...
            <div class="input-group">
                ...
                <div class="invalid-feedback">Campo obrigátorio de no máximo 255 caracteres</div>
            </div>
        ...
        <div class="mb-3">
            ...
            <div class="input-group">
                ...
                <div class="valid-feedback">Está correto.</div>
                <div class="invalid-feedback">Campo obrigátorio inválido</div>
            </div>
